...
#' @export
#' @return If return_coefs is FALSE (the default), fir_nodelay return the filtered signal (same size as x). If return_coefs is TRUE, returns the vector of filter coefficients only.
