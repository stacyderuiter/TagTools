...
*The spatial resolution looks much, much better!*
</div>
...
*The current would need to be moving quite a bit south, and also some distance west, in order to compensate.*
</div>
...
*They don't capture the movement of the animal very well. So much happens between the positions that we're able to collect at the surface.*
</div>
