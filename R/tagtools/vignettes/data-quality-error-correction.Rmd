...
## Data quality checks
For this practical we will use data from a tag attached to the back of a sperm whale. The data is in: `rawtestset3.nc`. If you need to download it, it is available from the animal tags website, either at http://animaltags.org/ or https://animaltags.netlify.app/ . 
...
The magnetometer data should also have fairly constant vector magnitude equal to the field strength where the data came from. It should be about 48 $\mu$T in this case since the tag was deployed at $28.48^{\circ}$, $-89.052^{\circ}$ latitude/longitude. (That is, 28.48 north latitude, 89.052 west longitude.)
