...
*We know now that the whale is likely not foraging in the shallow dive. However, it is still moving quite a bit, so resting seems unlikely too. Thus we can classify this shallow dive as most likely a traveling dive.*
</div>
