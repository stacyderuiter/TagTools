...
This will write the file "cats_test_raw.nc", and load it into your current R session as a list object called `MN`. Looks good? Good work! Confused? See `load-tag-data`.
...
*If you'd like to keep working through these practicals, `plots-and-cropping` is a fairly logical continuation. You should always feel free to search for whichever practical seems most logical or relevant for your data or interests.*
