...
For this example, we will make use of a CATS tag data file that is already stored in a .nc file called 'cats_test_raw.nc'. The data is available at the animal tags website, http://animaltags.org/ or https://animaltags.netlify.app/ .
...
*If you'd like to continue working through these vignettes, `data-quality-error-correction` is probably a good option.*