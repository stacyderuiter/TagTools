...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To begin, I will load the blue whale data from the tagtools package and generate my acceleration matrix (within the whale frame). The acceleration matrix within the whale frame will be labeled as "Aw". I will also create a variable "fs" that specifies the sampling rate of my acceleration data, which is to run the njerk function.
