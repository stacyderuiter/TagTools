...
## Prerequisites
Before you begin, you must have R and -- recommended -- RStudio installed on your computer. You can download [this software at RStudio.com](https://www.rstudio.com/products/rstudio/#rstudio-desktop). If you happen to be new to R also, here are two very nice standalone tutorials: [#1](https://rsconnect.calvin.edu:3939/content/141) and [#2](https://rstudio.cloud/learn/primers/1.2).
...
```{r}
dpnds <- c('CircStats', 'ggformula', 'graphics', 'hht', 'latex2exp', 'lubridate', 'magrittr', 'matlab', 'ncdf4', 'plotly', 'pracma', 'readr', 'rgl', 'signal', 'stats', 'utils', 'zoo', 'zoom')
