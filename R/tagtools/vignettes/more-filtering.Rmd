...
For this practical we will use data from a suction cup tag attached to the back of a beaked whale. The data is in `testset1`. This dataset is built into the `tagtools` package, so you can access it using `system.file`. 
