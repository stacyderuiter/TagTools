...
*3.* **Help. The resolution looks fine...?**
...
*1. Incorrect calibration of the sensor and temperature sensitivity have both been addressed by now, since the whale is actually resting and breathing at the surface, rather than ten mebers in the air. Additionally, some of the occasional outliers have been removed by the median filter.* 

*However, none of this has increased the resolution of the depth data. In order to resolve this last issue, while you could interpolate linearly, this will be just an approximation of actual high-resolution data. Ultimately, new data would have to be taken at higher resolution to truly address this.* 
</div>
