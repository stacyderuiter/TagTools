...
*If you'd like to continue working through these vignettes, consider `complementary-filtering`. In it, you'll look at acceleration data, and consider quick changes in acceleration (high-frequency acceleration) versus slower changes (low-frequency acceleration) to interpret an animal's behavior.* 
