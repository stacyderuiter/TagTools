...
#' @export
#' @examples \dontrun{ nc_filename <- read_cats('my_cats_file.csv', 'my_cats_deplyment_name')
...
read_cats <- function(fname,depid){
  ...
  Sens_name <- c('3 axis Accelerometer','3 axis Magnetometer','3 axis Gyroscope',
