...
#' 
#' Possible input combinations: htrack(A,M,s,fs) if A and M are matrices, htrack(A,M,s,fs,fc) if A and M are matrices, htrack(A,M,s) if A and M are lists, htrack(A,M,s,fc = fc) if A and M are lists.
