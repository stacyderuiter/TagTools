...
detect_peaks <- function(data, sr, FUN = NULL, thresh = NULL, bktime = NULL, plot_peaks = NULL, ...) {
  ...
  if (plot_peaks == TRUE) {
    ...
    graphics::plot(dnew, type = "l", col = "blue", xlim = c(0, length(dnew)), ylim = c(0, max(dnew)), xlab = "Jerk", ylab = "Time (units of sampling_rate)")
    ...
    graphics::plot(x, y, pch = 9, type = "p", col = "orange", xlim = c(0, length(dnew)), ylim = c(0, max(dnew)), cex = .75, xlab = "Jerk", ylab = "Time (units of sampling_rate)")
