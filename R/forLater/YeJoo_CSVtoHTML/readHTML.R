...
parseCSV<-function(csvfilename){
  ...
  local_index <- grep("dephist.deploy.locality", a1$field)
  ...
  deploy_date_index <- grep("dephist.deploy.datetime.start", a1$field)
  ...
  device_date_index <- grep("dephist.device.datetime.start", a1$field)
