...
#'          Y <- fir_nodelay(x=x, n=30, fp=0.2, qual='low')
#'          plot(x,Y$y) $need a better vis or example here!
...
fir_nodelay <- function(x, n, fp, qual='low'){
  # input checking
  # ================================================================
  ...
  # generate fir filter
  # ============================================================
  h <- signal::fir1(n=n,w=fp, type=qual)
