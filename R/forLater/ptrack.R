#' Simple dead-reckoned track (pseudo-track) estimation based on speed and body pointing angle. 
#'
...
#' @param S Specifies whether you want to receive the output "S". The input can be any number and the default is NULL (meaning you don't receive the output "S")
#' @param pe Specifies whether you want to receive the output "pe". The input can be any number and the default is NULL (meaning you don't receive the output "pe")
...
ptrack <- function(A, M, s, fs, fc = NULL, LPF = NULL, S = NULL, pe = NULL) {
  #input checks----------------------------------------------------------
  if (nargs() < 4) {
