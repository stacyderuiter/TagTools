# The following is an attempt to translate Mark Johnson's bodyaxes.m matlab script, from the dtag tool box, to an R script. Note that we made no
...
#
#		Example:
# 		 W = bodyaxes(matrix(c(-0.3, 0.52, 0.8, 22, -22, 14), byrow = TRUE, nrow = 2, ncol = 3)
