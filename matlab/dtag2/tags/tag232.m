function    CAL = tag232(date)
%
%     CAL = tag232([date])
%     Calibration file for tag232
...
% SF - 1/08/10; added new cal constants
...
CAL.ACAL = [4.02 -1.02
 ...
 % 1/08/10 Accel mean = 1.0004 std = .022863 

CAL.MCAL = [-74.74 3.14
	    -77.68 1.51
	     84.35 -1.31] ;

 % 1/08/10 Magnetometer mean = 46.772 std = 2.089    
