DEV = struct ;
DEV.ID=upper('2f031d0f');  %Needs to be upper case
DEV.NAME='D131';
DEV.BUILT=[2013 3 20];
DEV.BUILDER='SF';
...
PRESS=struct;
PRESS.POLY=[-555.8 3365.7 -107.3];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2013 4 30];
PRESS.TREF = 20 ;
...
ACC.POLY=[4.902 -2.368; 4.931 -2.455; 4.981 -2.484] ;
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
ACC.METHOD='flips';
ACC.LASTCAL=[2013 4 30];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
MAG.POLY=[566.712 -181.890; 599.151 -195.651; 606.097 -241.699] ;
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
