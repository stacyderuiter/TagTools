DEV = struct ;
DEV.ID=upper('47031D2A'); %Needs to be upper case
DEV.NAME='D108';
DEV.BUILT=[2012 5 1];
DEV.BUILDER='TH';
...
PRESS=struct;
PRESS.POLY=[62.35 3276.64 -104.52];
PRESS.METHOD='rough';
...
ACC.POLY=[4.993 2.460; 5.017 -2.488; 4.975 -2.462];
ACC.UNIT='g';
ACC.TREF = 20 ;
...
MAG.POLY=[707.119 -263.467; 714.723 -145.032; 730.431 -321.233];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
