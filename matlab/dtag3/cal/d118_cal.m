...
PRESS=struct;
PRESS.POLY=[74.97 2903.22 -136.67];
PRESS.METHOD='rough';
...
ACC.POLY=[4.990 -2.440; 4.930 -2.500; 4.950 -2.440] ;
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[664.970 -217.380; 667.880 -199.280; 721.690 -249.460] ;
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
