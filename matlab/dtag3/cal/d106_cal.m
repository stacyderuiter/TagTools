...
ACC.POLY=[4.984 -2.528; 5.01 -2.528; 5.042 -2.611] ; %changed sign of (1,1) so all first terms are pos sdr 29 jan 2012
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[756.5 -285; 772.2 -245.8; 761.7 -251.8] ;
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
