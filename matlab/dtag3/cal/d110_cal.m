DEV = struct ;
DEV.ID=upper('15031E17'); %Needs to be upper case
DEV.NAME='D110';
DEV.BUILT=[2012 5 1];
DEV.BUILDER='TH';
...
ACC.POLY=[5.023 2.467; 4.986 -2.500; 5.011 -2.473] ; % 1st row needs to be positive
ACC.UNIT='g';
ACC.TREF = 20 ;
...
MAG.POLY=[680.368 -225.321; 705.882 -166.980; 747.954 -246.488] ;
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
