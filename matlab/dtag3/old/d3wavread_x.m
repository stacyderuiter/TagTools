function    [x,fs] = d3wavread_x(cues,recdir,prefix,suffix)
%
...
[ct,ref_time,fs,fn,recdir] = d3getcues_x(recdir,prefix,suffix) ; %this version of getcues takes into account the possibility of overflow "wavx" files
