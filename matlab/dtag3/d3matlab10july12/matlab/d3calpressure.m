function    [p,CAL] = d3calpressure(X,CAL,test)

%    [p,CAL] = d3calpressure(X,CAL,[test])
...
if strcmp(test,'full') | strcmp(test,'tempr'),
   ...
   CAL.PRESS = calptc(p,t,CAL.PRESS,PRESSRANGE,NOTEMP) ; % gui for temperature compensation
end
