function     RES = ceetag3audit(tag,tcue,RES,fhigh,z)

%     Tagaudit tool adapted for version 3 DTAG deployments. Subject to change.
%
%     R = ceetag3audit(tag,tcue,R) will start the audit program for the
%     specified deployment tag at start cue tcue and using a pre-existing
%     audit structure R.
%
%     R = ceetag3audit(tag,tcue,R,fhigh,z) will start a
