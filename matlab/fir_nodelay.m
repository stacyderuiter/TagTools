...
%		 (i.e., samples of x). The length should be at least 4/fp. A longer filter
%		 gives a steeper cut-off.
%     fp is the filter cut-off frequency relative to 1=Nyquist frequency. If a single
%		 number is given, the filter is a low-pass or high-pass. If fp is a vector with 
%		 two numbers, the filter is a bandpass filter with lower and upper cut-off frequencies
%		 given by fp(1) and fp(2). For a bandpass filter, n should be at least 4/fp(1) or
%		 4/diff(fp) whichever is larger.
