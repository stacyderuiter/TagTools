function    [A,CAL] = autocalacc_sd(s,p,t,CAL,test)
...
if nargin==5 & ~isempty(test)
   [A,CAL]=calacc_sd(s,p,t,CAL,test);

else  
   fprintf(' Bias calibration...\n') ;
   [A,CAL]=calacc_sd(s,p,t,CAL,'bias');
   fprintf(' Pressure calibration...\n') ;
   [A,CAL]=calacc_sd(s,p,t,CAL,'p');
   fprintf(' Temperature calibration...\n') ;
   [A,CAL]=calacc_sd(s,p,t,CAL,'t');
   fprintf(' Sensitivity calibration...\n') ;
   [A,CAL]=calacc_sd(s,p,t,CAL,'sens');
   fprintf(' Cross-axis calibration...\n') ;
   [A,CAL]=calacc_sd(s,p,t,CAL,'cross');
end
