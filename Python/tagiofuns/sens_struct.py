def sens_struct(data=None,fs=None,depid=None,sens_type=None,name=None,ordered=False):
    ...
    Generate a sensor structure from a sensor data list or array.
       ...
       Inputs:
       data is a list of sensor data. This can be in any unit and frame but the metadata generated by sens_struct assumes a default
       ...
       T is the time in seconds of each measurement in data for irregularly sampled data. The time reference (i.e., the 0 time) should be with
